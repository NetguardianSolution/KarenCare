              ...
              <div key={product.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="p-6">
                  ...
                  <Link
                    ...
                    className="w-full bg-[#4d1515] flex items-center justify-center text-white py-3 rounded-lg font-semibold hover:bg-black transition-colors duration-200 text-center"
                  >
